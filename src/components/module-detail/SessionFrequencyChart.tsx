...
const PATH =
  'M 0 170 C 80 165, 114 140, 171 110 S 286 70, 343 55 S 457 45, 514 60 S 628 95, 685 115 S 742 125, 800 130';
...
export function SessionFrequencyChart() {
  ...
  return (
    <div ref={containerRef} className="mt-4 rounded-xl bg-gray-50 p-4 sm:p-6">
      ...
      <div className="mt-2 grid grid-cols-4 gap-0.5 text-[9px] sm:flex sm:justify-between sm:text-xs">
