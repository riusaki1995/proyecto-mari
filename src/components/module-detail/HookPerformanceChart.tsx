...
const PATH =
  'M 0 45 C 55 50, 110 58, 165 65 S 275 88, 330 98 S 440 118, 495 128 S 605 145, 660 152 S 715 158, 770 163 S 790 166, 800 168';
...
export function HookPerformanceChart() {
  ...
  const [dot, setDot] = useState({ x: 0, y: 45 });
  ...
  return (
    <div ref={containerRef} className="mt-4 rounded-xl bg-gray-50 p-4 sm:p-6">
      ...
      <div className="mt-2 grid grid-cols-4 gap-0.5 text-[6px] sm:grid-cols-6 sm:text-[9px] md:flex md:justify-between md:text-[10px] lg:text-xs">
