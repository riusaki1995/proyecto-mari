...
const PATH =
  'M 0 50 C 120 58, 200 72, 320 88 S 480 118, 560 135 S 680 152, 800 165';

const LABELS = ['TikTok LIVE', 'TikTok Clips', 'YouTube', 'Instagram', 'Twitter/X', 'Podcast'];
...
export function PlatformROIChart() {
  ...
  return (
    <div ref={containerRef} className="mt-4 rounded-xl bg-gray-50 p-4 sm:p-6">
      ...
      <div className="mt-2 grid grid-cols-3 gap-1 text-[8px] sm:flex sm:justify-between sm:text-xs">
