...
const PATH =
  'M 0 170 C 70 168, 140 162, 210 152 S 330 125, 400 100 S 520 70, 590 55 S 690 42, 760 38, 800 35';

const LABELS = ['Sem1', 'Sem2', 'Sem3', 'Sem4', 'Sem5', 'Sem6', 'Sem7', 'Sem8', 'Sem9', 'Sem10'];
...
export function WeeklyGrowthChart() {
  ...
  const [dot, setDot] = useState({ x: 0, y: 170 });
  ...
  return (
    <div ref={containerRef} className="mt-4 rounded-xl bg-gray-50 p-4 sm:p-6">
      ...
      <div className="mt-2 grid grid-cols-5 gap-0.5 text-[8px] sm:flex sm:justify-between sm:text-xs">
